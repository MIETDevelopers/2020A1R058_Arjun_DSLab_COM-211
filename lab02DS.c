   ...
   do
   {
      ...
      switch (operation){
         case 1:
            ...
            scanf("%d", &value);
            push(stackA, value);    // calling the push function
            break;
         case 2:
            printf("\nPop out the element\n");
            int popped = pop(stackA,value); // calling the pop function
            if (stackA->top == INT_MIN)
            {
               return INT_MIN;
            }
            else
            ...
            break;
         case 3:
            peek(stackA);       // calling the peek function
            break;
        case 4:

...
int pushStack(struct Stack *stack, char value)
{
   if(isFull(stack))
   {
      printf("\nStack Overflow\n");
...
int popStack(struct Stack *stack, char value)
{
   if(isEmpty(stack))
   {
      printf("\nStack Underflow\n");
